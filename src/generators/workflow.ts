...
import type { DaedalionConfig, GeneratedFile, BuildOptions } from '../types.js';

export function generateWorkflow(config: DaedalionConfig, outputDir: string, options: BuildOptions = {}): GeneratedFile {
...
function generateValidateOnlyWorkflow(config: DaedalionConfig): string {
...
function generateAutoCommitWorkflow(config: DaedalionConfig): string {
