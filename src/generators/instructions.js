...
export function generateInstructions(openspecDir, outputDir, config, options = {}) {
  ...
  if (existsSync(projectPath)) {
    ...
    content = transformProjectToInstructions(projectContent, config);
  } else {
    content = generateDefaultInstructions(config);
  }
...
function transformProjectToInstructions(projectContent, config) {
...
function generateDefaultInstructions(config) {
